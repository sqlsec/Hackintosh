...
因为 OpenCore 的核显配置 文件是 .list 结尾的，所以需要专门的编辑器来编辑，常见的 OC 编辑器的优缺点如下：

| 编辑器名称            | 优点               | 缺点             |
| --------------------- | ------------------ | ---------------- |
| ProperTree            | 强大、专业、跨平台 | 上手难度高       |
| OpenCore Configurator | 强大、简单         | 只有 Mac 版本    |
| QtOpenCoreConfig      | 跨平台、简单       | 使用体验有待提升 |
...
中文说明为：https://github.com/ic005k/QtOpenCoreConfig/blob/master/READMe-en.md
