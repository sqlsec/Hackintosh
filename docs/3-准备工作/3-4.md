...
3. 使用 OC 官方的下载页面来下载常见的 kexts：[https://dortania.github.io/builds/](https://dortania.github.io/builds/)
...
- [X] [**RadeonSensor.kext 和 SMCRadeonGPU.kext**](https://github.com/aluveitie/RadeonSensor/releases)
...
- [X] [**USBToolBox.kext 与 UTBMap.kext**](/6-实用姿势/6-1.html#reloaded)
	- [ ] **USBToolBox.kext **
		* 官方下载地址为：https://github.com/USBToolBox/kext/releases
	- [ ] **UTBMap.kext**
		* 需要参考 [USB 定制教程](/6-实用姿势/6-1/)自己生成
...
- [X] [**IntelBluetoothFirmware.kext 与 IntelBluetoothFirmware.kext**](https://github.com/OpenIntelWireless/IntelBluetoothFirmware/releases)
	* Intel 网卡的蓝牙驱动，与 `AirportItlwm.kext` 搭配使用
	* 只支持 macOS 10.13 以及更高的版本
	* 如果确定你的网卡型号支持驱动，但是蓝牙无法使用，那么多半是你的 USB 没有定制好
	* macOS 12 后蓝牙驱动的姿势又有小变化，详细可参考：[macOS 12 蓝牙](/6-实用姿势/6-7/)
...
- [X] [**BrcmPatchRAM 系列**](https://github.com/acidanthera/BrcmPatchRAM/releases)
...
!!! warning "博通网卡的几个细节，Big Sur 以及后面的系统由于驱动有点异常，需要手动删除 *AirPortBrcm4360_Injector.kext*"
...
- [X] [**VoodooPS2Controller.kext**](https://github.com/acidanthera/VoodooPS2/releases)
	* 适用于配备 PS2 键盘、鼠标和触控板的系统
	* MT2 (Magic Trackpad 2) 功能需要 macOS 10.11 或更新版本
- [X] [**RehabMan 的 VoodooPS2Controller.kext**](https://bitbucket.org/RehabMan/os-x-voodoo-ps2-controller/downloads/)
	* 老的系统支持的比较好，新系统建议使用上面的 kext
	* 对于带有 PS2 键盘、鼠标和触控板的旧系统，或者当您不想使用 VoodooInput 时
	* 支持 macOS 10.6+ 支持
- [X] [**VoodooRMI.kext 和 VoodooSMBus.kext**](https://github.com/VoodooSMBus/VoodooRMI/releases)
...
- [X] [**VoodooI2C.kext**](https://github.com/VoodooI2C/VoodooI2C/releases)
	...
	* 一般是一些更高级的触摸板和或者是触摸屏
	* MT2 (Magic Trackpad 2) 功能需要 macOS 10.11 或更新版本
	* 这个经常 PS2 的 Kexts 使用，需要微调才可以，否则可能会报错，详情可见：[Kexts 微调](/3-准备工作/3-8/)
	* VoodooI2C 的一些插件
		- [ ] VoodooI2CHID.kext
...
- [X] [**CPUFriend.kext 和 CPUFriendDataProvider.kext**](https://github.com/acidanthera/CPUFriend/releases)
...
- [X] [**RealtekCardReaderFriend.kext 和 RealtekCardReader.kext**](https://github.com/0xFireWolf)
